...
import com.example.map_my_sona.RegisterPage;
...
//                }
                    ...
                    Intent intent=new Intent(ComplaintPage_user.this, ScannerPage.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);
                    Toast.makeText(ComplaintPage_user.this, "Invalid QR Code", Toast.LENGTH_SHORT).show();
                }
            }
