...
public class Complaints_HistoryDetails_Painting extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference_complaints_history_painter.orderByChild("status").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        toolbar = findViewById(R.id.topAppBar_painting);
                ...
                refDash.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (pos.equals("admin")||pos.equals("supervisor")) {
                            startActivity(new Intent(Complaints_HistoryDetails_Painting.this, Dep_wise_history.class));
                        } else {
