...
public class complaint_HistoryDetails_assets extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference_complaints_history_assets.orderByChild("status").addValueEventListener(new ValueEventListener() {
            @Override
...
//                Toast.makeText(getApplicationContext(),"your icon was clicked",Toast.LENGTH_SHORT).show();
                refDash.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(pos.equals("admin")){
                            startActivity(new Intent(complaint_HistoryDetails_assets.this, dashboard.class));
                        }
                        else{
