...
public class historyviewdetails_manual_carpenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historyviewdetails_manual_carpenter);
        ...
        com_id_manual=(TextView) findViewById(R.id.Comid_unit_his_manual_carpenter);
        staffName_manual=(TextView) findViewById(R.id.staff_name_unit_his_manual_carpenter);
        Dep_Res_manual=(TextView) findViewById(R.id.dep_unit_his_manual_carpenter);
        Branch_manual=(TextView) findViewById(R.id.branch_history_com_manual_carpenter);
        loc_manual=(TextView) findViewById(R.id.loc_unit_his_manual_carpenter);
        object_manual=(TextView) findViewById(R.id.object_unit_his_manual_carpenter);
        com_det_manual=(TextView) findViewById(R.id.com_det_unit_his_manual_carpenter);
        level_of_com_manual=(TextView) findViewById(R.id.level_of_com_unit_his_manual_carpenter);
        intercomNum_manual=(TextView) findViewById(R.id.intercom_num_unit_his_manual_carpenter);
        phone_num_manual=(TextView) findViewById(R.id.phone_unit_his_manual_carpenter);

        uref_m= FirebaseAuth.getInstance().getUid();

        com_status_his_manual=(TextView) findViewById(R.id.complaint_status_his_manual_carpenter);

        comp_close_manual=(Button)findViewById(R.id.close_the_com_his_manual_carpenter);

        com_txt_manual=(TextView) findViewById(R.id.com_txt_history_manual_carpenter);

        reference_complaints_history_fullView_manual= FirebaseDatabase.getInstance()
                .getReference("Manual complaints").child("Carpenting").child(com_id_new);
        reference_complaints_history_fullView_manual.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(historyviewdetails_manual_carpenter.this, "Something Went Wrong !!! ", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View view) {
                if (status_manual.equals("Pending")){
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(snapshot.exists()){
                                if(pos.equals("admin")){
                                                ...
                                                public void onClick(DialogInterface dialogInterface, int i) {
                                                    ...
                                                    reference_complaints_history_fullView_manual.updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
                                                        ...
                                                        public void onSuccess(Object o) {
                                                            Toast.makeText(historyviewdetails_manual_carpenter.this, "Complaint closed", Toast.LENGTH_SHORT).show();
                                                            if(ContextCompat.checkSelfPermission(historyviewdetails_manual_carpenter.this, Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_GRANTED){
                                                                sendMessage();
                                                            }
                                                            else{
                                                                ActivityCompat.requestPermissions(historyviewdetails_manual_carpenter.this,
                                                                        new String[]{Manifest.permission.SEND_SMS},
                                                                        100);
                                                            }
                                                            Intent intent=new Intent(historyviewdetails_manual_carpenter.this, Complaints_HistoryDetails_Carpenter_manual.class);
                                    ...
                                    Toast.makeText(historyviewdetails_manual_carpenter.this, "Complaint is not made by you so cant close it", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    ...
                    if(uid_manual_str.equals(uref_m)){
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        reference_complaints_history_fullView_manual.updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
                                            ...
                                            public void onSuccess(Object o) {
                                                ...
                                                Toast.makeText(historyviewdetails_manual_carpenter.this, "Complaint opened Again", Toast.LENGTH_SHORT).show();
                                                Intent intent=new Intent(historyviewdetails_manual_carpenter.this, Complaints_HistoryDetails_Carpenter_manual.class);
                                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                startActivity(intent);
                        ...
                        Toast.makeText(historyviewdetails_manual_carpenter.this, "This complaint is not made by you so you cant close it", Toast.LENGTH_SHORT).show();
                    }
                    Toast.makeText(historyviewdetails_manual_carpenter.this, "This complaint is already solved and closed", Toast.LENGTH_SHORT).show();
                }
            }
        });
