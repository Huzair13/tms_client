...
public class rating_carpenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rating_carpenter);

        recyclerView_complaints_history=findViewById(R.id.recyclerview_rating_car);
        reference_complaints_history= FirebaseDatabase.getInstance().getReference("complaints").child("Carpenter");
        ...
        reference_complaints_history.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(rating_carpenter.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
