package com.example.tms_sona2.complaints.viewDetails;
...
//    private EditText other_feedback;
    ...
    private TextView location,staff_name,com_id,staff_mob,powerRating,wexpiry,wperiod,ins_by,ins_date,com_txt,make,model,config;
...
//                Toast.makeText(getApplicationContext(),"your icon was clicked",Toast.LENGTH_SHORT).show();
        ...
        staff_name = (TextView) findViewById(R.id.staff_name_unit_his_net);
        //staff_dep=(TextView)findViewById(R.id.dep_unit_his);
        com_id = (TextView) findViewById(R.id.Comid_unit_his_net);
        staff_mob = (TextView) findViewById(R.id.staff_mob_history_com_net);
        powerRating = (TextView) findViewById(R.id.powerRating_unit_his_net);
        wexpiry = (TextView) findViewById(R.id.warranty_exp_unit_his_net);
        wperiod = (TextView) findViewById(R.id.warranty_unit_his_net);
        ins_by = (TextView) findViewById(R.id.ins_by_unit_his_net);
        ins_date = (TextView) findViewById(R.id.ins_date_unit_his_net);
        //mob=(TextView)findViewById(R.id.mob_unit_his);
        com_txt = (TextView) findViewById(R.id.com_txt_history_networks);
        location = (TextView) findViewById(R.id.location_unit_his_net);
        ...
        mob_row = (TableRow) findViewById(R.id.com_by_mob_eh_net);
        makeRow = (TableRow) findViewById(R.id.makeRow_eh_net);
        modelRow = (TableRow) findViewById(R.id.modelRow_eh_net);
        powerRatRow = (TableRow) findViewById(R.id.powerRat_row_eh_net);
        wperiodrow = (TableRow) findViewById(R.id.warrantyPeriodRow_eh_net);
        wexpiryrow = (TableRow) findViewById(R.id.wexpiryRow_eh_net);
        ins_byRow = (TableRow) findViewById(R.id.ins_by_Row_eh_net);
        ...
        sn_powerRat = (TextView) findViewById(R.id.sn_powerRat_eh_net);
        sn_wperiod = (TextView) findViewById(R.id.sn_warperiod_eh_net);
        sn_wexpiry = (TextView) findViewById(R.id.sn_wexpiry_eh_net);
        sn_ins_by = (TextView) findViewById(R.id.sn_ins_by_eh_net);
        sn_ins_date = (TextView) findViewById(R.id.sn_ins_date_eh_net);
        sn_loc = (TextView) findViewById(R.id.sn_loc_eh_net);
        sn_config = (TextView) findViewById(R.id.sn_config_eh_net);
...
//        feedBack_txtView_head=(TextView)findViewById(R.id.his_elec_feedBack_head_txt_net);
        ...
        bt_send_admin=(Button)findViewById(R.id.send_Admin_comment_net);
        bt_send_supervisor=(Button)findViewById(R.id.send_Supervisor_comment_net);
        ll_com_admin=(LinearLayout)findViewById(R.id.LL_comment_admin_net);
        ll_com_superVisor=(LinearLayout)findViewById(R.id.LL_comment_Supervisor_net);
        ed_com_admin=(EditText)findViewById(R.id.ET_comment_admin_net);
        ed_com_supervisor=(EditText)findViewById(R.id.ET_comment_supervisor_net);
    ...
    private void updateCommentSupervisor(String toString) {
        ...
        reference_complaints_history_fullView.updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onSuccess(Object o) {
                Toast.makeText(historyviewdetails_networks.this, "Sent !!!", Toast.LENGTH_SHORT).show();
                Intent i=new Intent(historyviewdetails_networks.this,Complaints_HistoryDetails_Networks.class);
