...
public class rating_electricity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rating_electricity);

        recyclerView_complaints_history=findViewById(R.id.recyclerview_rating_elec);
        ...
        reference_complaints_history.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(rating_electricity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
