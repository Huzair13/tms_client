...
public class rating_network extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rating_network);

        recyclerView_complaints_history=findViewById(R.id.recyclerview_rating_net);
        reference_complaints_history= FirebaseDatabase.getInstance().getReference("complaints").child("Network");
        ...
        reference_complaints_history.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(rating_network.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
