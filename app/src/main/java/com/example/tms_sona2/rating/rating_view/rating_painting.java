...
public class rating_painting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rating_painting);

        recyclerView_complaints_history=findViewById(R.id.recyclerview_rating_paint);
        reference_complaints_history= FirebaseDatabase.getInstance().getReference("complaints").child("Painting");
        ...
        reference_complaints_history.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(rating_painting.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
